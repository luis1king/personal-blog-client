...
<div className="card" data-state="#about">
  <div className="card-header">
    ...
    <img className="card-avatar" src={luis} alt="avatar" />
    <h1 className="card-fullname">Luis Huang</h1>
    <h2 className="card-jobtitle">Dessarrollador web Y Emprendedor </h2>
  </div>
  <div className="card-main">
    <div className="card-section is-active" id="about">
      <div className="card-content">
        <div className="card-subtitle">SOBRE MÍ</div>
        <p className="card-desc"> Me llamo Luis Huang, soy un apasionado de la tecnología, negocios y deportes. Actualmente me encuentro en proceso de desarrollo personal, buscando sacar mi máximo potencial.
        </p>
      </div>
